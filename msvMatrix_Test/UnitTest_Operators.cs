...
namespace msvMatrix_Test
{
    ...
    public class UnitTest_Operators
    {
        ...
        public void Test_030_IsSquare()
        {
            ...
            {
                Assert.Fail($"Ошибка проверки на квадратность: {e.Message}");
            }
        }
        [TestMethod]
        ...
        public void Test_034_IsVectorRow()
        {
            ...
            {
                Assert.Fail($"Ошибка проверки на вектор-строку: {e.Message}");
            }
        }
        [TestMethod]
        ...
        public void Test_037_IsVectorCol()
        {
            ...
            {
                Assert.Fail($"Ошибка проверки на вектор-столбец: {e.Message}");
            }
        }
        [TestMethod]
        ...
        public void Test_040_IsScalar()
        {
            ...
            {
                Assert.Fail($"Ошибка проверки на скаляр: {e.Message}");
            }
        }
        [TestMethod]
        ...
        public void Test_045_IsDiag()
        {
            ...
            {
                Assert.Fail($"Ошибка проверки на диагональность: {e.Message}");
            }
        }
        [TestMethod]
